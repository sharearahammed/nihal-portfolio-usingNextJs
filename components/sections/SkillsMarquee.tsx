...
export default function SkillsMarquee() {
  ...
  return (
    <section className="py-16 border-t border-white/[0.05] overflow-hidden">
        ...
        <div className="flex gap-6 marquee-track" style={{ width: "max-content" }}>
          {doubled.map((tech, i) => (
            ...
            >
              ...
              />
              <span
                className="text-sm text-[#888] whitespace-nowrap"
        ...
        >
          {[...doubled].reverse().map((tech, i) => (
            ...
            >
              ...
              />
              <span
                className="text-sm text-[#666] whitespace-nowrap"
                style={{ fontFamily: "Syne, sans-serif", fontWeight: 500 }}
              >
                {tech}
              </span>
