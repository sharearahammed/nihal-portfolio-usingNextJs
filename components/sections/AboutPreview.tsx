    ...
    const ctx = gsap.context(() => {
      ...
      imgTl
        ...
        .fromTo(
          ...
          { y: 0, opacity: 1, scale: 1, duration: 0.65, stagger: 0.15, ease: "back.out(1.6)" },
          "-=0.4"
        );
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          <div ref={imageWrapRef} className="relative">
            ...
            >
              <div
                ...
                style={{ height: "480px" }}
              >
                <Image src="/aboutMe.png" alt="About Nihal" fill className="object-cover" />
                <div
              ...
              <div
                ...
                style={{ background: "var(--bg)", transformOrigin: "right center", zIndex: 10 }}
              />
            </div>

            {/* Floating stat cards */}
            <div ref={statsRef} className="absolute -right-6 top-[-35px] grid grid-cols-1 gap-3">
              {stats.slice(0, 2).map((s) => (
                ...
                >
                  <p className="text-2xl font-bold text-[#F97316]" style={{ fontFamily: "Syne, sans-serif" }}>
                    {s.value}
                  </p>
            ...
            >
              <p className="text-xs mb-0.5" style={{ color: "var(--text-muted)" }}>Education</p>
          ...
          <div ref={textRef}>
            ...
            <p className="about-item text-sm leading-relaxed mb-4" style={{ color: "var(--text-secondary)" }}>
              {personalInfo.bio}
            </p>
            <p className="about-item text-sm leading-relaxed mb-10" style={{ color: "var(--text-secondary)" }}>
              Passionate about turning complex problems into elegant, user-friendly web solutions.
              I thrive in collaborative environments and am always eager to learn cutting-edge technologies.
            </p>
            ...
            <div ref={cardsRef} className="grid grid-cols-2 gap-4 mb-10">
              {highlights.map((item) => (
                ...
                >
                  ...
                  <p className="text-xs font-semibold mb-0.5" style={{ fontFamily: "Syne, sans-serif", color: "var(--text-primary)" }}>
                    {item.title}
                  </p>
            ...
            <div className="about-item">
              <Link href="/about" className="btn-brand inline-flex items-center gap-2">
                Know More About Me
                <HiArrowRight />
              </Link>
            </div>
