        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <div
              ...
              style={{ borderRadius: "16px", height: 480, background: "#111" }}
            >
              <Image
                src="/aboutMe.png"
                alt="About Nihal"
            ...
            <div className="absolute -right-6 top-[-35px] grid grid-cols-1 gap-3">
              {stats.slice(0, 2).map((s) => (
                <motion.div
                  ...
                  style={{ background: "#1A1A1A", border: "1px solid rgba(249,115,22,0.2)", minWidth: 100 }}
                >
            ...
            <div
              ...
              style={{ backdropFilter: "blur(16px)", background: "rgba(26,26,26,0.9)", border: "1px solid rgba(255,255,255,0.08)" }}
            >
              <p className="text-xs text-[#666] mb-0.5">Education</p>
              <p className="text-sm text-white font-semibold" style={{ fontFamily: "Syne, sans-serif" }}>
